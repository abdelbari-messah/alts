...
=============================================*/
  ...
  var scrollLink = $(".section-link").filter(function () {
    ...
    try {
      ...
      var linkPage = parsedHref.pathname.split("/").pop() || "index.html";
      return linkPage === currentPage && $(this.hash).length > 0;
    } catch (e) {
      return false;
    }
  });

  // Active link switching (only for sections that exist on the current page)
  if (scrollLink.length) {
    $(window).on("scroll", function () {
      ...
      scrollLink.each(function () {
        ...
        var sectionOffset = targetSection.offset().top - 90;
